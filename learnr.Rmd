...
pacman::p_load_gh("rundel/learnrhash")
pacman::p_load(tidyverse)
pacman::p_load(gradethis)
pacman::p_load(shinyalert)
...
encoded_txt = shiny::eventReactive(input$hash_generate, 
                                   {
                                     ...
                                     response <- httr::GET(paste0("https://6d4b-2001-4c4e-2504-1500-59ed-2a21-1eac-ebba.ngrok-free.app/echo?msg=", t)) |>
                                       httr::content() |> 
                                       purrr::pluck("msg")
                                     message(response)
                                     if (!is.null(response)) {
...
![](images/CleanShot 2023-09-07 at 20.52.57@2x.png){width="80%"}
